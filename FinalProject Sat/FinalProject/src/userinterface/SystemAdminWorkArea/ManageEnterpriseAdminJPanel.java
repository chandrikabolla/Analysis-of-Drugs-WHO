...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if (password.isEmpty()) {
            ...
            isValid = false;
        } else if (!password.isEmpty() && !password.matches(passwordRegEx)) {
            int messageType = JOptionPane.ERROR_MESSAGE;
        ...
        account = enterprise.getUserAccountDirectory().createEmployeeUserAccount(userName, password, employee, new AdminRole());
        }
        else if(enterprise.getEnterpriseType()==Enterprise.EnterpriseType.Manufacture)
        {
            account = enterprise.getUserAccountDirectory().createEmployeeUserAccount(userName, password, employee, new ManufactureAdminRole());
       
        }
        else if(enterprise.getEnterpriseType()==Enterprise.EnterpriseType.Distributor)
        {
            account = enterprise.getUserAccountDirectory().createEmployeeUserAccount(userName, password, employee, new DistributorAdminRole());
